<template>
    ...
    >
        <div class="rounded-b-lg shadow-abyan-blue-900/10 shadow-lg mx-auto grid max-w-xl items-center gap-x-8 gap-y-10 pb-8 grid-cols-2 md:grid-cols-5 md:mx-0 md:max-w-none">
            ...
            <!-- Nuxt HATES honda. long story short, do not put honda.png nor anything honda related into this section -->
            ...
            <img width="158" height="48" src="/brands/toyota.png" alt="Toyota Logo" class="max-h-12 w-full object-contain"/>
        </div>
